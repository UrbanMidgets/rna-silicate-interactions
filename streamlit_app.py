...
def format_relative_energy_export_table(source_df):
    formatted = source_df[
        [
            'nucleotide',
            'solvent_state',
...
def build_relative_energy_export_html(source_df):
    ...
    formatted = format_relative_energy_export_table(export_df)
...
def render_relative_energy_comparison_table(source_df):
    ...
    export_html = build_relative_energy_export_html(display_source)
    st.download_button(
